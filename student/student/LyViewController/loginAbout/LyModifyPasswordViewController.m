...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [tfOldPwd setText:nil];
    [tfNewPwd setText:nil];
}
...
//    [tfOldPwd setBackgroundColor:[UIColor whiteColor]];
    ...
    //新密码
    UIView *viewNewPwd = [[UIView alloc] initWithFrame:CGRectMake(0, viewOldPwd.frame.origin.y + CGRectGetHeight(viewOldPwd.frame)+verticalSpace, SCREEN_WIDTH, LyViewItemHeight)];
    ...
    //修改按钮
    btnModify = [[UIButton alloc] initWithFrame:CGRectMake( SCREEN_WIDTH/2.0f-btnModifyWidth/2.0f, viewNewPwd.frame.origin.y+CGRectGetHeight(viewNewPwd.frame)+verticalSpace*3.0f, btnModifyWidth, btnModifyHeight)];
...
{
    [forgotPasswordVC.navigationController popToViewController:self animated:YES];

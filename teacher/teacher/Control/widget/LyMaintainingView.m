...
- (void)initAndLayoutSubviews {
    ...
    lbTitle = [[UILabel alloc] initWithFrame:CGRectMake(horizontalSpace, ivIcon.ly_y+CGRectGetHeight(ivIcon.frame)+mVerticalMargin, mWidth-horizontalSpace*2, mLbTitleHeight)];
    ...
    tvReason = [[UITextView alloc] initWithFrame:CGRectMake(horizontalSpace, lbTitle.ly_y+CGRectGetHeight(lbTitle.frame)+mVerticalMargin/2.0f, mWidth-horizontalSpace*2, mTvReasonHeight)];

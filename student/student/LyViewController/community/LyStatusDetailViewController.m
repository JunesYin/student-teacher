...
#import "LyDriveSchoolDetailViewController.h"
...
//                    [tvFooterView stopAnimation];
        ...
        case statusDetailHttpMethod_transmit: {
            ...
            switch ( [strCode integerValue]) {
                ...
                default: {
                    LyRemindView *remind = [LyRemindView remindWithMode:LyRemindViewMode_fail withTitle:@"转发失败"];
                    [remind show];
                    break;
                }
            }

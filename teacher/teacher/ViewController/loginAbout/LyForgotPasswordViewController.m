...
- (void)initAndLayoutSubviews {
    ...
    //验证-验证码
    UIView *viewAuthCode = [[UIView alloc] initWithFrame:CGRectMake(0, tfAccount.ly_y+CGRectGetHeight(tfAccount.frame)+verticalSpace, SCREEN_WIDTH, LyViewItemHeight)];

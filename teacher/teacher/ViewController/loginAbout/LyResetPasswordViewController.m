...
- (void)initAndLayoutSubviews {
    ...
    //新密码
    UIView *viewNewsPwd = [[UIView alloc] initWithFrame:CGRectMake(0, lbCurAcc.ly_y + CGRectGetHeight(lbCurAcc.frame) + 10.0f, SCREEN_WIDTH, LyViewItemHeight)];
    ...
    //密码格式提示
    UILabel *lbPsdRemind = [[UILabel alloc] initWithFrame:CGRectMake(horizontalSpace, viewNewsPwd.ly_y+CGRectGetHeight(viewNewsPwd.frame)+verticalSpace, (SCREEN_WIDTH-horizontalSpace*2), 40.0f)];
    ...
    btnReset = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/4.0f, lbPsdRemind.ly_y+CGRectGetHeight(lbPsdRemind.frame)+50.0f, SCREEN_WIDTH/2.0f, 40.0f)];

...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        ivMore = [[UIImageView alloc] initWithFrame:CGRectMake( SCREEN_WIDTH-horizontalSpace-lmstcIvMoreSize, lmstcellHeight/2.0f-lmstcIvMoreSize/2.0f, lmstcIvMoreSize, lmstcIvMoreSize)];

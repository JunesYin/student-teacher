...
#define extBarFrame_var                 CGRectMake(0, self.tvNews.ly_y + CGRectGetHeight(self.tvNews.frame) + verticalSpace, SCREEN_WIDTH, ndebHeight)
...
//    [viewTransmitInfo setFrame:CGRectMake(0, viewHeader.ly_y + CGRectGetHeight(viewHeader.frame), SCREEN_WIDTH, fHeighttvTransmitInfo)];
    [tvTransmitInfo setFrame:CGRectMake(0, viewHeader.ly_y + CGRectGetHeight(viewHeader.frame), SCREEN_WIDTH, fHeighttvTransmitInfo)];
...
//    [viewPraiseInfo setFrame:CGRectMake(0, viewHeader.ly_y + CGRectGetHeight(viewHeader.frame), SCREEN_WIDTH, fHeighttvPraiseInfo)];
    [tvPraiseInfo setFrame:CGRectMake(0, viewHeader.ly_y + CGRectGetHeight(viewHeader.frame), SCREEN_WIDTH, fHeighttvPraiseInfo)];
...
- (void)reloadViewHeaderData {
    ...
    [viewHeader setFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.extBar.ly_y + ndebHeight + verticalSpace)];
...
- (void)showViewNull_evaluation {
    if (!viewNull_evaluation) {
        viewNull_evaluation = [[UIView alloc] initWithFrame:CGRectMake(0, viewHeader.ly_y+CGRectGetHeight(viewHeader.frame), SCREEN_WIDTH, SCREEN_HEIGHT)];

...
- (void)initAndLayoutSubview
{
    ...
    datePicker = [[UIDatePicker alloc] initWithFrame:CGRectMake( 0, toolBar.frame.origin.y+toolBar.frame.size.height+2, CGRectGetWidth(viewUseful.frame), CGRectGetHeight(viewUseful.frame)-CGRectGetHeight(toolBar.frame))];
    [datePicker setBackgroundColor:[UIColor whiteColor]];
    NSDate *minDate = [[LyUtil dateFormatterForYMD] dateFromString:@"1949-01-01"];
    [datePicker setBackgroundColor:[UIColor whiteColor]];
...
{
    if (_delegate && [_delegate respondsToSelector:@selector(onBtnCancelClickBydatePicker:)])
    {

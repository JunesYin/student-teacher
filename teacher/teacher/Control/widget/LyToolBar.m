...
{
    if ( self = [super initWithFrame:CGRectMake( 0, 0, SCREEN_WIDTH, 40)])
    {
        _inputControl = input;
...
- (void)initAndLayoutSubviews
{
    ...
    barBtnSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace
                                                                target:nil
                                                                action:nil];
    barBtnDone = [[UIBarButtonItem alloc] initWithTitle:@"完成"
                                                  style:UIBarButtonItemStyleDone
                                                 target:self
                                                 action:@selector(targetForBarButotnItem:)];

...
CGFloat const sspccBtnDeleteSize = 20.0f;
...
- (void)initSubviews
{
    ...
    btnDelete = [[UIButton alloc] initWithFrame:CGRectMake( ivPic.frame.origin.x+CGRectGetWidth(ivPic.frame)-sspccBtnDeleteSize, 0, sspccBtnDeleteSize, sspccBtnDeleteSize)];

...
NSString *const app_boudleIdentifier             = @"com.517xueche.apple.student";
NSString *const appStore_id                      = @"1107516226";
NSString *const appStore_url                     = @"itms-apps://itunes.apple.com/app/id1107516226";

NSString *const host_url                         = @"www.517xc.com";


NSString *const share_url    = @"https://www.517xc.com";
NSString *const shareTitle   = @"我要去学车";
NSString *const shareContent = @"听说用“我要去学车”的小伙伴都成功拿到驾照了，你还在等什么？";
NSString *const shareContent_sinaWeibo = @"听说用“我要去学车”的小伙伴都成功拿到驾照了，你还在等什么？https://www.517xc.com";


NSString *const appSchmeStudent                = @"student517xueche";

//Apple Pay
NSString *const appMerchantIdentifier           = @"merchant.com.517xueche.apple.student";


//支付宝相关
NSString *const alipayPartner                    = @"2088111222703104";
NSString *const alipayAppId                      = @"2016041401298266";
...
//qq相关
NSString *const qqAppId                          = @"1105392647";//41E2F407
NSString *const qqAppKey                        = @"Mkb1rNRLGfbcRfAC";

//新浪微博相关
NSString *const sinaWeiBoAppKey                  = @"2722584653";
NSString *const sinaWeiBoAppSercet               = @"0e8271e78da7cca3a12ca6686197c2a3";
NSString *const sinaAuth_url                     = @"https://www.517xc.com/Admin/Index/sinaAuth";
NSString *const cancelSinaAuth_url               = @"https://www.517xc.com/Admin/Index/cancelSinaAuth";

//微信相关
NSString *const weChatAppId                      = @"wxdcfe42426859659b";
NSString *const weChatAppSecret                  = @"4eb1665e926347eed9d2f06f58772e72";

//mob相关
NSString *const shareSDKAppKey                   = @"143acb886de36";
NSString *const shareSDKAppSecret                = @"621977b533e739eb707b130ccec5bb7e";

//JPush相关
NSString *const JPushAppKey                     = @"fad71f0a96f4dc6626afe2d2";
NSString *const JPushMasterSecret               = @"a4870316e6178b8790c5bd93";
...
NSString *const userId517Key                     = @"userId517Key__xy";
NSString *const userAccount517Key                = @"userAccount517Key__xy";
NSString *const userPassword517Key               = @"userPassword517Key__xy";
NSString *const userName517Key                   = @"userName517Key__xy";
//NSString *const userAutoLoginFlagKey = @"";




CGFloat const avatarSizeMax = 300;
...
NSString *const userModeKey                      = @"type";
...
NSString *const verifyStateKey                  = @"verify";
...
NSString *const precedenceKey                   = @"priority";
...
NSString *const coachModeKey                     = @"jltype";//0=普通//1=私人
...
NSString *const prepay517depositKey              = @"prepay517deposit";


NSString *const classIdKey                       = @"classid";
NSString *const classNameKey                     = @"classname";
NSString *const classTimeKey                    = @"classtime";
...
NSString *const driveSchoolNameKey               = @"schoolname";
NSString *const driveSchoolIdKey                 = @"schoolid";



//驾考学堂
NSString *const myDriveSchoolNameKey             = @"myschool";
NSString *const myCoachNameKey                   = @"mycoach";
NSString *const myGuiderNameKey                  = @"myguider";
NSString *const myDriveSchoolIdKey               = @"myschoolid";
...
NSString *const orderPayTimeKey                 = @"paytime";
...
NSString *const orderPreferentialPriceKey        = @"preferentialprice";
...
NSString *const curQuestionIdKey             = @"start";
...
//NSString *const statusMasterIdKey                = @"masterid";
//NSString *const statusTimeKey                    = @"time";
//NSString *const statusContentKey                 = @"content";
//NSString *const statusPicCountKey                = @"piccount";;
//NSString *const statusPraiseCountKey             = @"praisecount";
//NSString *const statusEvalutionCountKey          = @"evalutioncount";
//NSString *const statusTransmitCountKey           = @"transmitcount";
//NSString *const statusExtrasKey                  = @"extras";
//NSString *const statusPraiseFlagKey              = @"flag";
NSString *const newsIdKey                      = @"newsid";
...
NSString *const objectnewsIdKey                = @"objecthingid";
...
NSString *const AliPayCallback_url       = @"https://www.517xc.com/Admin/Driving/alipayCallBack";
NSString *const realmName_517            = @"https://www.517xc.com";
//NSString *const realmName_517          = @"www.517xc.com";

//获取当前最低支持的应用版本号
NSString *const lowestAppVersion_url     = @"https://www.517xc.com/Admin/Index/version";
//获取当前banner数量
NSString *const activityCount_url        = @"https://www.517xc.com/Admin/Index/bannerCount";
//登录网址
NSString *const login_url                = @"https://www.517xc.com/Admin/Index/check";
//注册网址
NSString *const register_url             = @"https://www.517xc.com/Admin/Index/adduser";
//退出接口
NSString *const logout_url               = @"https://www.517xc.com/Admin/Index/logout";
//个人信息
NSString *const userInfo_url             = @"https://www.517xc.com/Admin/index/userinfo";
//修改个人信息
NSString *const modifyUserInfo_url       = @"https://www.517xc.com/Admin/Index/updateuinfo";
//获取用户名称
NSString *const getUserName_url          = @"https://www.517xc.com/Admin/Index/getUserName";

//发送验证码
NSString *const getAuthCode_url          = @"https://www.517xc.com/Admin/Index/sends";
//验证验证码
NSString *const checkAuchCode_url        = @"https://www.517xc.com/Admin/Index/verification";
//修改密码
NSString *const modifyPassword_url       = @"https://www.517xc.com/Admin/Index/passupdate";
//重设密码
NSString *const resetPassword_url        = @"https://www.517xc.com/Admin/Index/passreset";
//添加关注
NSString *const addAttention_url         = @"https://www.517xc.com/Admin/Index/addmycon";
//取消关注
NSString *const removeAttention_url      = @"https://www.517xc.com/Admin/Index/removemycon";
//获取我的关注
NSString *const getMyAttention_url       = @"https://www.517xc.com/Admin/Index/myconcern";
//意见反馈
NSString *const feedback_url             = @"https://www.517xc.com/Admin/Index/feedback";
//扫一扫用户验证
NSString *const issetUserId_url          = @"https://www.517xc.com/Admin/Index/userisset";
...
//搜索驾校
NSString *const searchSchool_url         = @"https://www.517xc.com/Admin/Search/newschoolsearch_2";
//搜索教练
NSString *const searchCoach_url          = @"https://www.517xc.com/Admin/Search/newcoachsearch_2";
//搜索指导员
NSString *const searchGuider_url         = @"https://www.517xc.com/Admin/Search/newguidersearch_2";


//获取驾校列表
NSString *const getTeacherList_url       = @"https://www.517xc.com/Admin/Coach/getpublicList1";
//详情
NSString *const getTeacherDetail_url     = @"https://www.517xc.com/Admin/Coach/teacherDetail";
//获取附近驾校
NSString *const getNearTeacher_url       = @"https://www.517xc.com/Admin/Coach/getCoachadd";
//获取所有评论
...
#pragma mark -message
//msg center
NSString *const msgCenter_url            = @"https://www.517xc.com/Admin/Coach/stunewmessage";
// eva msg
...
//驾考学堂
NSString *const driveExam_url            = @"https://www.517xc.com/Admin/Driving/dirsch";
//添加
NSString *const addMyTeacher_url         = @"https://www.517xc.com/Admin/Driving/addMyTeacher";
//更换
NSString *const replaceTeacher_url       = @"https://www.517xc.com/Admin/Driving/updateTeacher";
//指导员
NSString *const selfCitys_url            = @"https://www.517xc.com/Admin/Driving/selfCity";
//添加时获取所有
NSString *const getTeacher_url           = @"https://www.517xc.com/Admin/Driving/returnAllTeacher";
//我的驾校
NSString *const myDriveShcool_url        = @"https://www.517xc.com/Admin/Driving/mydrisch1";
//根据驾校基地科目获取教练
NSString *const getTrainCoach_url        = @"https://www.517xc.com/Admin/Driving/getTrainCoach1";
//我的驾校更多教练
NSString *const getMoreCoach_url         = @"https://www.517xc.com/Admin/Driving/getMoreCoach1";
//我的驾校预约教练
NSString *const reservateCoach_url       = @"https://www.517xc.com/Admin/Driving/reserCoach1";
//我的教练
NSString *const myChoach_url             = @"https://www.517xc.com/Admin/Driving/getCoachInfo1";
//创建预约
NSString *const reservate_url            = @"https://www.517xc.com/Admin/Driving/addmyreser";
//我的指导员
NSString *const myGuider_url             = @"https://www.517xc.com/Admin/Driving/getGuiderinfo";
//指导员计时预约
NSString *const reservateGuider_url      = @"https://www.517xc.com/Admin/Driving/returnGuiderRes";
//报名咨询
NSString *const guiderApply_url          = @"https://www.517xc.com/Admin/Driving/guiderList";


//创建订单
NSString *const createOrder_url          = @"https://www.517xc.com/Admin/Driving/mylist";
//订单中心
NSString *const orderCenter_url          = @"https://www.517xc.com/Admin/Driving/listcenter";
//取消订单
NSString *const cancelOrder_url          = @"https://www.517xc.com/Admin/Driving/cancellist";
//删除订单
NSString *const deleteOrder_url          = @"https://www.517xc.com/Admin/Driving/dellist";
//评价订单
NSString *const evaluateOrder_url        = @"https://www.517xc.com/Admin/Driving/evaluatlist";
//确认订单
NSString *const confirmOrder_url         = @"https://www.517xc.com/Admin/Driving/confirmlist";
//获取订单支付状态
NSString *const confirmPayState_url      = @"https://www.517xc.com/Admin/Driving/newOrderState";
//银联获取TN订单号
NSString *const getTn_url                = @"https://www.517xc.com/Admin/Pay/appConsume";
//银联Apple Pay获取tn
NSString *const getApplePayTn_url        = @"https://www.517xc.com/Admin/Applepay/appConsume";

////理论学习
////全真模考
//NSString *const examing_url              = @"https://www.517xc.com/Admin/Theory/truetheory";
////全真模考-科目四
//NSString *const examing4_url             = @"https://www.517xc.com/Admin/Theory/truetheory4";
////考试完成
//NSString *const saveScore_url            = @"https://www.517xc.com/Admin/Theory/savescore";
////考试纪录
//NSString *const examHistory_url          = @"https://www.517xc.com/Admin/Theory/returnscore";
////章节练习
//NSString *const chapterStudy_url         = @"https://www.517xc.com/Admin/Theory/zjtestnum";
////章节练习---题目
//NSString *const chapterExecise_url       = @"https://www.517xc.com/Admin/Theory/chapter_1";
////章节练习--收藏
//NSString *const collecte_url             = @"https://www.517xc.com/Admin/Theory/addMytheory";
////试题分析
//NSString *const questionAnalysis_url     = @"https://www.517xc.com/Admin/Theory/getAnalysis";
////我的错题
//NSString *const myMistake_url            = @"https://www.517xc.com/Admin/Theory/ctestnum1";
////查看错题
//NSString *const viewMyMistake_url        = @"https://www.517xc.com/Admin/Theory/viewMyerror";
////练习错题
//NSString *const execiseMyMistake_url     = @"https://www.517xc.com/Admin/Theory/myerrorTest";
////清空我的错题
//NSString *const clearMyMistake_url       = @"https://www.517xc.com/Admin/Theory/trunMyerrorTheory";
////我的题库
//NSString *const myLibrary_url            = @"https://www.517xc.com/Admin/Theory/Mytheory";
////清空我的题库
//NSString *const clearMyLibrary_url       = @"https://www.517xc.com/Admin/Theory/trunMyBank";
////查看我的题库
//NSString *const viewMyLibrary_url        = @"https://www.517xc.com/Admin/Theory/MytheoryTest";
////删除我的题
//NSString *const decollecteQuestion_url   = @"https://www.517xc.com/Admin/Theory/delMyBank";

//驾考圈
//发表动态
NSString *const sendNews_url             = @"https://www.517xc.com/Admin/Dynamic/sendDynamic";
//获取我的动态
NSString *const getMyNews_url            = @"https://www.517xc.com/Admin/Dynamic/getMyDynamic";
//获取所有动态
NSString *const getAllNews_url           = @"https://www.517xc.com/Admin/Dynamic/getAllDynamic";
//点赞
NSString *const praise_url               = @"https://www.517xc.com/Admin/Dynamic/thumb";
//取消赞
NSString *const depraise_url             = @"https://www.517xc.com/Admin/Dynamic/cancelthumb";
//评论（动态）
NSString *const statusEvalute_url        = @"https://www.517xc.com/Admin/Dynamic/evaluate";
//转发（动态）
NSString *const statusTransmit_url       = @"https://www.517xc.com/Admin/Dynamic/forwDynamic";
//动态详情
NSString *const statusDetail_url         = @"https://www.517xc.com/Admin/Dynamic/getNewsDetail";
//更多评价
NSString *const statusMoreEvalution_url  = @"https://www.517xc.com/Admin/Dynamic/moreEvaluation";
//与我相关
NSString *const aboutMe_url              = @"https://www.517xc.com/Admin/Dynamic/aboutMe";
//回复
NSString *const communityReply_url       = @"https://www.517xc.com/Admin/Dynamic/returnEvaluate";
//删除动态
NSString *const deleteNews_url           = @"https://www.517xc.com/Admin/Dynamic/delDynamic";
//用户详情
NSString *const userDetail_url           = @"https://www.517xc.com/Admin/Dynamic/userDetails";

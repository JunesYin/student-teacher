...
//    self.label.frame = CGRectMake(LEFT_MARGIN, TOP_MARGIN, labelSize.width, labelSize.height);
    CGFloat x = MAX(self.textContainerInset.left, LEFT_MARGIN);
    CGFloat y = MAX(self.textContainerInset.top, TOP_MARGIN);
    
    self.label.frame = CGRectMake(x, y, labelSize.width, labelSize.height);
}
@end

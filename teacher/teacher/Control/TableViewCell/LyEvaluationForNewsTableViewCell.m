...
- (void)setEva:(LyEvaluation *)eva
{
    ...
    [lbName setFrame:({
        CGRectMake( ivAvatar.frame.origin.x+ivAvatar.frame.size.width+horizontalSpace, ivAvatar.ly_y+2, sizeLbName.width, efntcLbNameHeight);
    })];
    ...
    [lbTime setFrame:CGRectMake( lbName.frame.origin.x, ivAvatar.ly_y+ivAvatar.frame.size.height-2-efntcLbTimeHeight, fWidthLbTime, efntcLbTimeHeight)];
    ...
    CGRect rectTest = CGRectMake( horizontalSpace, ivAvatar.ly_y+ivAvatar.frame.size.height, efntcTvContentWidth, fHeightTvContent);
    [tvContent setFrame:rectTest];
    
    _height = tvContent.ly_y+CGRectGetHeight(tvContent.frame)+verticalSpace;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( !flagSetTvReply)
    {
        ...
        else
        {
            ...
            [tvReply setFrame:CGRectMake( horizontalSpace, tvContent.ly_y+CGRectGetHeight(tvContent.frame)+verticalSpace, rcellWidth, heightSetTvReply)];

...
- (NSString *)startHttpRequest:(NSString *)strUrl body:(NSDictionary *)dicElements type:(LyHttpType)type timeOut:(NSTimeInterval)timeOut
{
    ...
    switch (type) {
        case LyHttpType_synGet: {
            return [self LyHttpType_synGet:strUrl body:dicElements timeOut:timeOut];
            break;
        }
        case LyHttpType_synPost: {
            return [self LyHttpType_synPost:strUrl body:dicElements timeOut:timeOut];
            break;
        }
        case LyHttpType_asynGet: {
            [self LyHttpType_asynGet:strUrl body:dicElements timeOut:timeOut completionHandler:nil];
            return @"YES";
            break;
        }
...
- (NSString *)LyHttpType_synGet:(NSString *)strUrl body:(NSDictionary *)dicElements timeOut:(NSTimeInterval)timeOut
{
...
- (NSString *)LyHttpType_synPost:(NSString *)strUrl body:(NSDictionary *)dicElements timeOut:(NSTimeInterval)timeOut
{
...
- (BOOL)LyHttpType_asynGet:(NSString *)url body:(NSDictionary *)dicElements timeOut:(NSTimeInterval)timeOut completionHandler:(LyHRCompletionHandler)completionHandler
{
    if ( timeOut < 1) {

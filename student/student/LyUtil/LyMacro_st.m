...
NSString *const priorityKey                     = @"priority";
...
NSString *const realmName_517            = @"http://192.168.67.163/10.19/php/Home";

//获取当前最低支持的应用版本号
NSString *const lowestAppVersion_url     = @"http://192.168.67.163/10.19/php/Home/Index/version";
//获取当前banner数量
NSString *const activityCount_url        = @"http://192.168.67.163/10.19/php/Home/Index/bannerCount";
//登录网址
...
//个人信息
NSString *const userInfo_url             = @"http://192.168.67.163/10.19/php/Home/index/userinfo";
//修改个人信息
...
//添加关注
NSString *const addAttention_url         = @"http://192.168.67.163/10.19/php/Home/Index/addmycon";
//取消关注
...
//NSString *const searchSchool_url       = @"http://192.168.67.163/10.19/php/Home/Search/newSearch";
NSString *const searchSchool_url         = @"http://192.168.67.163/10.19/php/Home/Search/newschoolsearch_2";
//搜索教练
//NSString *const searchCoach_url        = @"http://192.168.67.163/10.19/php/Home/Search/searchCoach";
//NSString *const searchCoach_url        = @"http://192.168.67.163/10.19/php/Home/Search/newSearchCoach";
NSString *const searchCoach_url          = @"http://192.168.67.163/10.19/php/Home/Search/newcoachsearch_2";
//搜索指导员
//NSString *const searchGuider_url       = @"http://192.168.67.163/10.19/php/Home/Search/searchGuider";
//NSString *const searchGuider_url       = @"http://192.168.67.163/10.19/php/Home/Search/newSearchGuider";
NSString *const searchGuider_url         = @"http://192.168.67.163/10.19/php/Home/Search/newguidersearch_2";


//获取驾校列表
NSString *const getTeacherList_url       = @"http://192.168.67.163/10.19/php/Home/Coach/getpublicList1";
//详情
//NSString *const getTeacherDetail_url   = @"http://192.168.67.163/10.19/php/Home/Coach/getTeacherDetail";
NSString *const getTeacherDetail_url     = @"http://192.168.67.163/10.19/php/Home/Coach/teacherDetail";
//获取附近驾校
NSString *const getNearTeacher_url       = @"http://192.168.67.163/10.19/php/Home/Coach/getCoachadd";
//获取所有评论
//NSString *const evaList_url            = @"http://192.168.67.163/10.19/php/Home/Coach/getAllList";
NSString *const evaList_url              = @"http://192.168.67.163/10.19/php/Home/Coach/allList";
//评价详情
NSString *const evaDetail_url            = @"http://192.168.67.163/10.19/php/Home/Coach/evaluatdetail";
//发表提问
//NSString *const sendConsult_url        = @"http://192.168.67.163/10.19/php/Home/Coach/addconsult";
NSString *const ask_url                  = @"http://192.168.67.163/10.19/php/Home/Coach/createconsult";
//获取所有提问
//NSString *const conList_url            = @"http://192.168.67.163/10.19/php/Home/Coach/getAllconList";
NSString *const conList_url              = @"http://192.168.67.163/10.19/php/Home/Coach/allconList";
//提问详情
...
#pragma mark -message
//msg center
NSString *const msgCenter_url            = @"http://192.168.67.163/10.19/php/Home/Coach/stunewmessage";
// eva msg
...
//我的钱包
//NSString *const myWallet_url           = @"http://192.168.67.163/10.19/php/Index/Admin/Wallet/getMyWallet";
...
//根据驾校基地科目获取教练
NSString *const getTrainCoach_url        = @"http://192.168.67.163/10.19/php/Home/Driving/getTrainCoach";
//我的驾校更多教练
NSString *const getMoreCoach_url         = @"http://192.168.67.163/10.19/php/Home/Driving/getMoreCoach";
//我的驾校预约教练
NSString *const reservateCoach_url       = @"http://192.168.67.163/10.19/php/Home/Driving/reserCoach";
//我的教练
...
//指导员计时预约
NSString *const reservateGuider_url      = @"http://192.168.67.163/10.19/php/Home/Driving/returnGuiderRes";
//报名咨询
...
//银联获取TN订单号
NSString *const getTn_url                = @"http://192.168.67.163/10.19/php/Home/Pay/appConsume";
//银联Apple Pay获取tn
NSString *const getApplePayTn_url        = @"http://192.168.67.163/10.19/php/Home/Applepay/appConsume";

//理论学习
//全真模考
NSString *const examing_url              = @"http://192.168.67.163/10.19/php/Home/Theory/truetheory";
//全真模考-科目四
NSString *const examing4_url             = @"http://192.168.67.163/10.19/php/Home/Theory/truetheory4";
//考试完成
NSString *const saveScore_url            = @"http://192.168.67.163/10.19/php/Home/Theory/savescore";
//考试纪录
NSString *const examHistory_url          = @"http://192.168.67.163/10.19/php/Home/Theory/returnscore";
//章节练习
//NSString *const chapterStudy_url       = @"https://www.517xc.com/Admin/Theory/zjtestnum1";
NSString *const chapterStudy_url         = @"https://www.517xc.com/Admin/Theory/zjtestnum";
//章节练习---题目
//NSString *const chapterExecise_url     = @"https://www.517xc.com/Admin/Theory/chapter";
NSString *const chapterExecise_url       = @"https://www.517xc.com/Admin/Theory/chapter_1";
//章节练习--收藏
NSString *const collecte_url             = @"http://192.168.67.163/10.19/php/Home/Theory/addMytheory";
//试题分析
NSString *const questionAnalysis_url     = @"http://192.168.67.163/10.19/php/Home/Theory/getAnalysis";
//我的错题
NSString *const myMistake_url            = @"http://192.168.67.163/10.19/php/Home/Theory/ctestnum1";
//查看错题
NSString *const viewMyMistake_url        = @"http://192.168.67.163/10.19/php/Home/Theory/viewMyerror";
//练习错题
NSString *const execiseMyMistake_url     = @"http://192.168.67.163/10.19/php/Home/Theory/myerrorTest";
//清空我的错题
NSString *const clearMyMistake_url       = @"http://192.168.67.163/10.19/php/Home/Theory/trunMyerrorTheory";
//我的题库
NSString *const myLibrary_url            = @"http://192.168.67.163/10.19/php/Home/Theory/Mytheory";
//清空我的题库
NSString *const clearMyLibrary_url       = @"http://192.168.67.163/10.19/php/Home/Theory/trunMyBank";
//查看我的题库
NSString *const viewMyLibrary_url        = @"http://192.168.67.163/10.19/php/Home/Theory/MytheoryTest";
//删除我的题
NSString *const decollecteQuestion_url   = @"http://192.168.67.163/10.19/php/Home/Theory/delMyBank";
...
//用户协议
NSString *const userProtocol_url         = @"http://www.517xc.com/Home/index/protocol";

//常见问题
NSString *const FAQ_url                  = @"http://www.517xc.com/Home/index/problems";

//学车指南
//学车流程
NSString *const guide_studyFlow_url      = @"http://www.517xc.com/Home/index/process";
//驾考大纲
NSString *const guide_outline_url        = @"http://www.517xc.com/Home/index/test";
//择校指南
NSString *const guide_selectionGuide_url = @"http://www.517xc.com/Home/index/choice";
//报名须知
NSString *const guide_applyNote_url      = @"http://www.517xc.com/Home/index/baoming";
//体检事项
NSString *const guide_physicalExam_url   = @"http://www.517xc.com/Home/index/examination";
//学车费用
NSString *const guide_studyFee_url       = @"http://www.517xc.com/Home/index/cost";
//作弊处量
NSString *const guide_cheating_url       = @"http://www.517xc.com/Home/index/cheat";
//残疾人学车
NSString *const guide_deformedMan_url    = @"http://www.517xc.com/Home/index/disabled";

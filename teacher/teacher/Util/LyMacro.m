...
//添加关注
NSString *const attente_url                     = @"https://www.517xc.com/Admin/Index/addmycon";
//取消关注
...
//获取所选城市所有基地
NSString *const getAllTrainBase_url             = @"https://www.517xc.com/Admin/Driving/returnAlltrain";
...
#pragma mark -学员
//获取学员
NSString *const getStudent_url                  = @"https://www.517xc.com/Admin/Coach/returnallstu";
//添加学员
NSString *const addStudent_url                  = @"https://www.517xc.com/Admin/Coach/addStudent";
//修改学员信息
NSString *const modifyStudent_url               = @"https://www.517xc.com/Admin/Coach/updateStu";
//删除学员
NSString *const deleteStudent_url               = @"https://www.517xc.com/Admin/Coach/delStu";


#pragma mark -teacher
#pragma mark -发布
//添加培训课程
NSString *const addTrainClass_url               = @"https://www.517xc.com/Admin/Coach/addClass";
//删除培训订程
NSString *const deleteTrainClass_url            = @"https://www.517xc.com/Admin/Coach/delClass";
//修改计时培训
NSString *const updateTimeTeachFlag_url         = @"https://www.517xc.com/Admin/Coach/uploadTimeflag";
//添加简介（修改简介）
NSString *const updateSynopsis_url              = @"https://www.517xc.com/Admin/Coach/uploadProfile";
//添加教学环境（修改，删除）
//添加教学环境
NSString *const updateTeachEnvironmnet_url      = @"https://www.517xc.com/Admin/Coach/coachupload";
//删除教学环境
NSString *const deleteTeachEnvironment_url      = @"https://www.517xc.com/Admin/Coach/delCoachimg";
//获取培训课程
NSString *const getTrainClass_url               = @"https://www.517xc.com/Admin/Coach/returnClass";
//获取简介
NSString *const getSynopsis_url                 = @"https://www.517xc.com/Admin/Coach/getAbstract";
//获取教学图片
NSString *const getTeachEnvironment_url         = @"https://www.517xc.com/Admin/Coach/getCoachimg";
//获取发布信息
NSString *const getPublishInfo_url              = @"https://www.517xc.com/Admin/Coach/getCoachs";
//修改学车成本
//NSString *const updateCost_url                  = @"https://www.517xc.com/Admin/Coach/updateCost";
//修改接送范围
NSString *const updatePickRange_url             = @"https://www.517xc.com/Admin/Coach/updatePickrange";
...
//获取基地
NSString *const getTrainBase_url                = @"https://www.517xc.com/Admin/TeaManage1/returnTrain";

//教学管理主界面
NSString *const teachManage_url                 = @"https://www.517xc.com/Admin/TeaManage1/teaManage";
//教练管理
NSString *const coachManage_url                 = @"https://www.517xc.com/Admin/TeaManage1/returnMycoach";
//添加教练
NSString *const addCoach_url                    = @"https://www.517xc.com/Admin/TeaManage1/addCoach";
//教练详情
NSString *const coachDetail_url                 = @"https://www.517xc.com/Admin/TeaManage1/returnCoachinfo";
//修改老师当前驾照
NSString *const modifyTeacherLicense_url        = @"https://www.517xc.com/Admin/TeaManage1/updateJtype";
//订时预约
NSString *const timeTeachManage_url             = @"https://www.517xc.com/Admin/Driving/reservationInfo";
//根据驾照类型获取价格详情
NSString *const priceDetailByLicense_url        = @"https://www.517xc.com/Admin/Driving/queryPriceInfo";
//添加价格详情
NSString *const addPriceDetail_url              = @"https://www.517xc.com/Admin/Driving/addPriceInfo";
//修改价格详情
NSString *const modifyPriceDetail_url           = @"https://www.517xc.com/Admin/Driving/updatePriceInfo";
//删除价格详情
NSString *const deletePriceDetail_url           = @"https://www.517xc.com/Admin/Driving/delPriceInfo";

//修改教练基地
NSString *const modifyCoachTrainBase_url        = @"https://www.517xc.com/Admin/TeaManage1/updateCoachTrain";
//删除教练
NSString *const deleteCoach_url                 = @"https://www.517xc.com/Admin/TeaManage1/updateMaster";
//基地管理
NSString *const trainBaseManage_url             = @"https://www.517xc.com/Admin/TeaManage1/trainManage";
//添加基地
NSString *const addTrainBase_url                = @"https://www.517xc.com/Admin/TeaManage1/addTrain";
//删除基地
NSString *const deleteTrainBase_url             = @"https://www.517xc.com/Admin/TeaManage1/delTrain";
//基地详情
...
//地标管理
NSString *const landMarkManage_url              = @"https://www.517xc.com/Admin/TeaManage1/landManage";
//获取某个区的所有地标
NSString *const getDistrictLandMark_url         = @"https://www.517xc.com/Admin/TeaManage1/returnLand";
//添加地标
NSString *const addLandMark_url                 = @"https://www.517xc.com/Admin/TeaManage1/addLand";
//删除地标
NSString *const deleteLandMark_url              = @"https://www.517xc.com/Admin/TeaManage1/delLand";
//操作地标
NSString *const operateLandMark_url             = @"https://www.517xc.com/Admin/TeaManage1/operLand";
...
//搜索驾校
NSString *const searchSchool_url                 = @"https://www.517xc.com/Admin/Search/search";
//搜索教练
NSString *const searchCoach_url                  = @"https://www.517xc.com/Admin/Search/searchCoach";
//搜索指导员
NSString *const searchGuider_url                 = @"https://www.517xc.com/Admin/Search/searchGuider";


//获取驾校列表
NSString *const getTeacherList_url               = @"https://www.517xc.com/Admin/Coach/getpublicList";
//详情
NSString *const getTeacherDetail_url             = @"https://www.517xc.com/Admin/Coach/getTeacherDetail";
//获取附近驾校
...
//我的驾校
NSString *const myDriveShcool_url                = @"https://www.517xc.com/Admin/Driving/mydrisch";
//根据驾校基地科目获取教练
NSString *const getTrainCoach_url                = @"https://www.517xc.com/Admin/Driving/getMoreCoach";
//我的驾校更多教练
NSString *const getMoreCoach_url                 = @"https://www.517xc.com/Admin/Driving/reserCoach";
//我的驾校预约教练
NSString *const reservateCoach_url               = @"https://www.517xc.com/Admin/Driving/getCoachInfo";
//我的教练
NSString *const myChoach_url                     = @"https://www.517xc.com/Admin/Driving/getCoachInfo";
//创建预约
...
//获取订单支付状态
NSString *const confirmPayState_url              = @"https://www.517xc.com/Admin/Driving/returnOrderState";

//订单中心
//订单中心//教练端
NSString *const orderCenter_url                 = @"https://www.517xc.com/Admin/Driving/coachListcenter";
//分配订单
NSString *const orderDispatch_url               = @"https://www.517xc.com/Admin/Driving/allocateList";
//当前可用教练-分配订单用

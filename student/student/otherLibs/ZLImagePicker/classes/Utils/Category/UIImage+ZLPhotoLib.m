...
//    return [UIImage imageWithContentsOfFile:[@"ZLPhotoLib.bundle" stringByAppendingPathComponent:[[NSString alloc] initWithFormat:@"/zl_%@",name]]];
    return [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle] pathForResource:@"ZLPhotoLib" ofType:@"bundle"] stringByAppendingFormat:@"/zl_%@", name]];
}

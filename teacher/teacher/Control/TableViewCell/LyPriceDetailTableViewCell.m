...
//        if (!btnModify) {
//            btnModify = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-pdBtnItemWidth*2, 0, pdBtnItemWidth, pdBtnItemHeight)];
//            [btnModify setTag:priceDetailTableViewCellButtonTag_delete];
//            [btnModify.titleLabel setFont:LyFont(12)];
//            [btnModify setTitleColor:Ly517ThemeColor forState:UIControlStateNormal];
//            [btnModify setTitle:@"修改" forState:UIControlStateNormal];
//            [btnModify addTarget:self action:@selector(targetForButton:) forControlEvents:UIControlEventTouchUpInside];
//        }

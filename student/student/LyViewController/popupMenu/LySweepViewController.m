...
CGFloat const viewBarHeight = 80.0f;

CGFloat const btnItemWidth = 100.0f;
#define btnItemHeight                       viewBarHeight
#define btnItemTitleFont                    LyFont(16)
#define btnItemSpace                        ((viewBarWidth-btnItemWidth*3)/4.0f)
        ...
        [alert addAction:[UIAlertAction actionWithTitle:@"设置"
                                                ...
                                                handler:^(UIAlertAction * _Nonnull action) {
                                                    ...
                                                    if ([[UIApplication sharedApplication] canOpenURL:url]) {
                                                        ...
                                                        [LyUtil showAlert:LyAlertForAuthorityMode_camera vc:self];
                                                    }
                                                }]];
...
- (void)setupScanView
{
    ...
    lbRemind = [[UILabel alloc] initWithFrame:CGRectMake( 0, viewScan.frame.origin.y+CGRectGetHeight(viewScan.frame)+verticalSpace*4, SCREEN_WIDTH, swpLbRemindHeight)];
    ...
    viewBar = [[UIView alloc] initWithFrame:CGRectMake( 0, CGRectGetHeight(self.view.frame)-viewBarHeight, viewBarWidth, viewBarHeight)];
...
{
    UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake( btnItemWidth*(buttonMode-sweepBarButtonMode_myCode)+btnItemSpace*(buttonMode-sweepBarButtonMode_myCode+1), 0, btnItemWidth, btnItemHeight)];
...
- (void)spTargetForBarButton:(UIButton *)button
{
    switch ( [button tag])
    {
        case sweepBarButtonMode_myCode:
        {
            ...
            {
                [LyUtil showLoginVc:self nextVC:qrCode showMode:LyShowVcMode_push];
            }
            break;
        }
        ...
        [alert addAction:[UIAlertAction actionWithTitle:@"设置"
                                                ...
                                                handler:^(UIAlertAction * _Nonnull action) {
                                                    ...
                                                    if ([[UIApplication sharedApplication] canOpenURL:url]) {
                                                        ...
                                                        [LyUtil showAlert:LyAlertForAuthorityMode_album vc:self];
                                                    }
                                                }]];
        [self presentViewController:alert animated:YES completion:nil];

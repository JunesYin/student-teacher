...
#define controlBarWidth                     self.view.frame.size.width
#define controlBarHeight                    70.0f

#define controlBarItemWidth                 100.0f
#define controlBarItemHeight                controlBarHeight
...
- (void)initControlBtn {
    ...
    UIView *viewControlBar = [[UIView alloc] initWithFrame:CGRectMake( 0, CGRectGetHeight(self.view.frame)-controlBarHeight, controlBarWidth, controlBarHeight)];
    [viewControlBar setBackgroundColor:[UIColor colorWithRed:50.0/255.0f green:50.0/255.0f blue:50.0/255.0f alpha:0.8]];
    
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, controlBarItemWidth, controlBarHeight)];
...
//    [cancelBtn setTitleEdgeInsets:UIEdgeInsetsMake(5.0f, 5.0f, 5.0f, 5.0f)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake( CGRectGetWidth(viewControlBar.frame)-controlBarItemWidth, 0, controlBarItemWidth, controlBarHeight)];
...
//    [confirmBtn setTitleEdgeInsets:UIEdgeInsetsMake(5.0f, 5.0f, 5.0f, 5.0f)];
    ...
    [viewControlBar addSubview:cancelBtn];
    [viewControlBar addSubview:confirmBtn];
    
    [self.view addSubview:viewControlBar];
}

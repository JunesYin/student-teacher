...
#define apWidth                                     SCREEN_WIDTH
#define apHeight                                    SCREEN_HEIGHT


#define viewUsefulWidth                             apWidth
#define viewUsefulHeight                            200.0f

#define toolBarWidth                                (viewUsefulWidth-verticalSpace*2)
#define toolBarHeight                               40.0f

#define pickerWidth                                 viewUsefulWidth
#define pickerHeight                                (viewUsefulHeight-toolBarHeight)
#define pickerRowHeight                             30.0f
...
- (void)initAndLayoutSubview
{
    ...
    switch ( _mode) {
        ...
        case LyAddressPickerMode_theoryStudy: {
            UIBarButtonItem *btnItemLocate = [[UIBarButtonItem alloc] initWithTitle:@"自动定位" style:UIBarButtonItemStyleDone target:self action:@selector(apTargetForBarButtonItem:)];
            [btnItemLocate setTag:LyControlBarButtonItemMode_ext];
            [toolBar setItems:@[btnItemCancel, btnItemSpace, btnItemLocate, btnItemDone]];
            break;

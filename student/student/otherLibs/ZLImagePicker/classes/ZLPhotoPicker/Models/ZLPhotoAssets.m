...
+ (instancetype)assetWithasset:(ALAsset *)asset
{
    ...
    zlAsset.asset = asset;
    zlAsset.isUIImage = YES;
    zlAsset.thumbImage = [UIImage imageWithCGImage:asset.thumbnail];
    zlAsset.originImage = [UIImage imageWithCGImage:[[asset defaultRepresentation] fullResolutionImage]];
    zlAsset.aspectRatioImage = [UIImage imageWithCGImage:asset.aspectRatioThumbnail];
...
//    return self.isUIImage ? _originImage : [UIImage imageWithCGImage:[[self.asset defaultRepresentation] fullResolutionImage]];
}

...
- (void)initSubviews
{
    ...
    [btnReply setImage:[LyUtil imageForImageName:@"btn_raply" needCache:NO] forState:UIControlStateNormal];
    ...
    lbName = [[UILabel alloc] initWithFrame:CGRectMake( ivAvatar.frame.origin.y+CGRectGetWidth(ivAvatar.frame)+horizontalSpace, ivAvatar.frame.origin.y, amtcLbNameWidth, amtcLbNameHeight)];
    ...
    lbTime = [[UILabel alloc] initWithFrame:CGRectMake( lbName.frame.origin.x, lbName.frame.origin.y+CGRectGetHeight(lbName.frame), lbTimeWidth, lbTimeHeight)];
    ...
    viewStatus = [[UIView alloc] initWithFrame:CGRectMake( horizontalSpace, ivAvatar.frame.origin.y+CGRectGetHeight(ivAvatar.frame)+verticalSpace, amtcViewStatusWidth, amtcViewStatusHeight)];
    ...
    tvReplay = [[UITableView alloc] initWithFrame:CGRectMake( horizontalSpace, viewStatus.frame.origin.y+CGRectGetHeight(viewStatus.frame)+verticalSpace, tvReplyWidth, tvReplyHeight)
...
- (void)setAboutMe:(LyAboutMe *)aboutMe
{
    ...
    _height = viewStatus.frame.origin.y+CGRectGetHeight(viewStatus.frame)+verticalSpace;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( !flagSetTvRepaly)
    {
        ...
        else
        {
            ...
            [tvReplay setFrame:CGRectMake( horizontalSpace, viewStatus.frame.origin.y+CGRectGetHeight(viewStatus.frame)+verticalSpace, tvReplyWidth, heightTvReplay)];
            
            _height = tvReplay.frame.origin.y + CGRectGetHeight(tvReplay.frame)+verticalSpace;
        }
    }

...
//    UIImage *flashButtonImage = [[UIImage imageNamed:@"JPSImagePickerController.bundle/flash_button"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *flashButtonImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle] pathForResource:@"JPSImagePickerController" ofType:@"bundle"] stringByAppendingString:@"/flash_button"]];
...
//    [self.cameraSwitchButton setBackgroundImage:[UIImage imageNamed:@"JPSImagePickerController.bundle/camera_switch_button"] forState:UIControlStateNormal];
    [self.cameraSwitchButton setBackgroundImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle] pathForResource:@"JPSImagePickerController" ofType:@"bundle"] stringByAppendingString:@"/camera_switch_button"]] forState:UIControlStateNormal];
